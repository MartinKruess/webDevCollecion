  ...
  return (
    <article>
      ...
      <p>
        ...
        üblichen geschweiften Klammern und Semikolons auskommt, ist die neuere Syntax
        von SCSS der von CSS ähnlich. SCSS wird gerne als die modernere Syntax
        bezeichnet.
      </p>
      <p>
        Damit SASS/SCSS von einem Browser verstanden wird, muss der Code zuerst in
        CSS konvertiert werden. Deshalb wird SASS als CSS-Präprozessor bezeichnet.
      ...
      <p>
        Die Installation von SASS ist ganz einfach mit NPM umzusetzen.
      </p>
      <pre>
