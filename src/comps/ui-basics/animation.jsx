export const Animation = () => {
  return (
    <article>
      ...
      <h2 className='font-extrabold text-xl pt-10'>Animationen</h2>
      <div className='animationBox'>
        <aside className='w-1/5'>
          <ul>
            ...
            <li>
              <a href='#ani2'>Was sind Animationen?</a>
            </li>
            <li>
              <a href='#ani3'>Was sind Animationen?</a>
            </li>
            <li>
              <a href='#ani4'>Was sind Animationen?</a>
            </li>
          </ul>
        </aside>
