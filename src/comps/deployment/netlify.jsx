  ...
  return (
    <article>
      ...
      <p>
        ...
        aktuell interessiert. Hierbei hast du die Möglichkeit schnell und bequem
        deine Projekte zu Hosten. Das ganze funktioniert über die Verknüpfung
        deines Repositories. Netlify arbeitet mit vielen Git-basierten
        Versionskontrollsystemen zusammen.
      </p>
      <p>
        Um Netlify als Hosting Service nutzen zu können benötigt man einen
        Account, mit dem Free-Tier. Im Dashboard findet man eine Übersicht über
        die veröffentlichten Projekte und Builds. Über den Button{" "}
        <span className={highlights.directory}>Add new site</span> kommt man zur
