    ...
    <article className="p-4">
      ...
      <div className="grid grid-cols-12 gap-x-20">
        ...
        <p className="col-start-5 col-end-13">
          ...
          erforderlichen (JavaScript-, Bild-, CSS-) Dateien analysiert und
          daraus Module erstellt. Diese wenigen Module werden dann an den
          Browser ausgeliefert, wodurch die Geschwindigkeit zur Laufzeit erhöht
          wird.
        </p>
        ...
        <p className="col-start-1 col-end-7">
          ...
          verschmerzbar, aber während der Entwicklung mit dem DevServer (der
        ...
        <p className="col-start-1 col-end-7">
          ...
          ES-Script-Module des Browsers, der Unterteilung des Projektcodes in
      ...
      <div className="grid grid-cols-12 gap-5">
        <h2 className="col-span-12 gap-10 font-extrabold text-2xl">
          Durchstarten it Vite
        </h2>
        <pre className="col-start-1 col-end-4">
          <code>npm create vite</code>
        </pre>
        <p className="col-start-5 col-end-13">
          Das erste Vite-Projekt aufzusetzen ist gar nicht so schwer. Wir gehen
          dafür erstmal in den Hauptordner zurück und erzeugen ein Project-File.
        </p>
        <img
          className="col-start-1 col-end-4"
          src="/images/createVite.png"
          alt=""
        />
        <p className="col-start-5 col-end-13">
          Nun vergeben wir den Namen des Projektes, sowie den Namen des
          Packages. Diese können ruhig gleich heißen.
        </p>
        <img
          className="col-start-1 col-end-4"
          src="/images/viteSelectFramework.png"
          alt=""
        />
        <p className="col-start-5 col-end-13">
          Da Vite nicht Framework gebunden ist, haben wir eine Auswahl einiger
          Frameworks. Aus dieser Auswahl beschäftigen wir uns erst einmal mit
          Vanilla JS. Abschließend währen wir als Sprache ebenfalls vanilla aus.
        </p>
        <img
          className="col-start-1 col-end-4"
          src="/images/viteInstructions.png"
          alt=""
        />
        <p className="col-start-5 col-end-13">
          Nach erfolgreicher Erstellung bekommen wir im Terminal drei
          Anweisungen, die wir Zeile für Zeile ausführen. Nun läuft unser erstes
          Projekt und wir können die nötigen Spezifikationen installieren.
          Abschließend setzen wir einen inital commit und pushen die erste
          Version auf Github.
        </p>
      </div>
    </article>
